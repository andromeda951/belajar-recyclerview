...
class TextWithEventAdapter2(private val listName: List<String>, private val listener: OnAdapterListener) :
    RecyclerView.Adapter<TextWithEventAdapter2.ViewHolder>() {
